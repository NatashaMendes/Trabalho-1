...
def criar_pool():
    ...
    # return _pool como é global a variavel agora, não precisa mais
...
def get_connection():
    ...
    try:
        if _pool is None:
            criar_pool() #Garante que teremos um
...
def iniciar_bd():
    try:
        ...
        with open(arquivo_sql, 'r', encoding='utf8') as f:
            script_sql = f.read()
        ...
        #    pass # Simplemente vai para frente. Continua executando
